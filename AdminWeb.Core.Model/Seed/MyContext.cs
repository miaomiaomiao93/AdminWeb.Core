...
namespace AdminWeb.Core.Model.Models
{
    public class MyContext
    {
        ...
        private static string _connectionString = File.Exists(@"D:\my-file\dbCountPsw1_1.txt") ? File.ReadAllText(@"D:\my-file\dbCountPsw1_1.txt").Trim() :Appsettings.app(new string[] { "AppSettings", "SqlServer", "SqlServerConnection" });
        ...
        {
            CreateClassFileByDBTalbe(strPath, "AdminWeb.Core.Entity");
        }
        /// <summary>
        /// 功能描述:根据数据库表生产实体类
        /// 作　　者:AdminWeb.Core
